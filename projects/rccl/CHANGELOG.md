...
### Fixed
* Fixed DDA fabric barrier publication race causing sporadic validation errors by moving the prologue barrier to release-acquire after index setup rather than at kernel entry.
